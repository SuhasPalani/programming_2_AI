...
# Initialize the nodes explored count
nodes_explored = 0
...
def forward_checking_mrv_solve(grid):
    ...
    def forward_check():
        nonlocal nodes_explored
        unassigned_cells = get_unassigned_cells()
    ...
    try:
        ...
        if mode in ("1", "2", "3"):
            ...
            if not solved:
                ...
                print("Search time: {:.4f} seconds".format(round(search_time, 3)))
                print("\nSolved puzzle:")
